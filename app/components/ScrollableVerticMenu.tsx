      ...
      <div className="flex flex-row  whitespace-nowrap">
        ...
        {scrollItems.map((item) => (
          ...
          <div key={item.id} className="pr-5">
            ...
            <Link to={item.link} href={`#${item.link}`} className="min-w-[110px] bg-white p-4 rounded shadow-lg drop-shadow-lg text-center text-sm flex items-center justify-center flex-col gap-y-2 hover:scale-105 hover:text-gray-300 transition-all duration-300" smooth duration={500} offset={-225} spy={true}>
